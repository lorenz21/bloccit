   ...
   describe("#getPoints()", () => {
    ...
    it("should return all the points for the associated post", (done) => {
      ...
      .then((vote) => {
        ...
        Post.create({
          title: "What it is like being on Proxima Centauri b",
          body: "The life is unexplainable.",
          userId: this.user.id,
          topicId: this.topic.id        
        })
        .then((newPost) => {
   ...
   describe("#hasUpvoteFor()", () => {
    ...
    it("should return true if the user with the associated userId has an upvote for the post", (done) => {
      ...
      .then((vote) => {
        ...
        Post.create({
          title: "Another space post",
          body: "We are all made of star stuff.",
          userId: this.user.id,
          topicId: this.topic.id        
        })
        .then((newPost) => {
   ...
   describe("#hasDownvoteFor()", () => {
    ...
    it("should return true if the user with the associated userId has an downvote for the post", (done) => {
      ...
      .then((vote) => {
        ...
        Post.create({
          title: "Another space boring post",
          body: "We are all made of star stuff, but you know that.",
          userId: this.user.id,
          topicId: this.topic.id        
        })
        .then((newPost) => {
